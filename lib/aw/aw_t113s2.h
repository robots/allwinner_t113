...
typedef enum IRQn
{
	...
	TCON_LCD_IRQn = (122), /*  Peripherial */
	TCON_TV_IRQn = (123), /*  Peripherial */
	...
	GPIOD10_IRQn = (288 + 10), /*  Peripherial */
	GPIOD11_IRQn = (288 + 11), /*  Peripherial */
	GPIOD12_IRQn = (288 + 12), /*  Peripherial */
	GPIOD13_IRQn = (288 + 13), /*  Peripherial */
	GPIOD14_IRQn = (288 + 14), /*  Peripherial */
	GPIOD15_IRQn = (288 + 15), /*  Peripherial */
	GPIOD16_IRQn = (288 + 16), /*  Peripherial */
	GPIOD17_IRQn = (288 + 17), /*  Peripherial */
	GPIOD18_IRQn = (288 + 18), /*  Peripherial */
	GPIOD19_IRQn = (288 + 19), /*  Peripherial */
...
{
	__IO uint32_t ADDR;                              /*!< Offset 0x000 TWI Slave Address Register */
	__IO uint32_t XADDR;                             /*!< Offset 0x004 TWI Extended Slave Address Register */
	__IO uint32_t DATA;                              /*!< Offset 0x008 TWI Data Byte Register */
	__IO uint32_t CNTR;                              /*!< Offset 0x00C TWI Control Register */
	__IO uint32_t STAT;                              /*!< Offset 0x010 TWI Status Register */
	__IO uint32_t CCR;                               /*!< Offset 0x014 TWI Clock Control Register */
	__IO uint32_t SRST;                              /*!< Offset 0x018 TWI Software Reset Register */
	__IO uint32_t EFR;                               /*!< Offset 0x01C TWI Enhance Feature Register */
	__IO uint32_t LCR;                               /*!< Offset 0x020 TWI Line Control Register */
	uint32_t reserved1 [0x0077];
	__IO uint32_t DRV_CTRL;                          /*!< Offset 0x200 TWI_DRV Control Register */
	__IO uint32_t DRV_CFG;                           /*!< Offset 0x204 TWI_DRV Transmission Configuration Register */
	__IO uint32_t DRV_SLV;                           /*!< Offset 0x208 TWI_DRV Slave ID Register */
	__IO uint32_t DRV_FMT;                           /*!< Offset 0x20C TWI_DRV Packet Format Register */
	__IO uint32_t DRV_BUS_CTRL;                      /*!< Offset 0x210 TWI_DRV Bus Control Register */
	__IO uint32_t DRV_INT_CTRL;                      /*!< Offset 0x214 TWI_DRV Interrupt Control Register */
	__IO uint32_t DRV_DMA_CFG;                       /*!< Offset 0x218 TWI_DRV DMA Configure Register */
	__IO uint32_t DRV_FIFO_CON;                      /*!< Offset 0x21C TWI_DRV FIFO Content Register */
	uint32_t reserved2 [0x0038];
	__IO uint32_t DRV_SEND_FIFO_ACC;                 /*!< Offset 0x300 TWI_DRV Send Data FIFO Access Register */
	__IO uint32_t DRV_RECV_FIFO_ACC;                 /*!< Offset 0x304 TWI_DRV Receive Data FIFO Access Register */
} TWI_TypeDef;
/*
 * @brief SPI
 */
...
{
	__IO uint32_t GCTL_REG;                          /*!< Offset 0x000 LCD Global Control Register */
	__IO uint32_t GINT0_REG;                         /*!< Offset 0x004 LCD Global Interrupt Register0 */
	__IO uint32_t GINT1_REG;                         /*!< Offset 0x008 LCD Global Interrupt Register1 */
	uint32_t reserved1;
	__IO uint32_t FRM_CTL_REG;                       /*!< Offset 0x010 LCD FRM Control Register */
	__IO uint32_t FRM_SEED_REG [0x006];              /*!< Offset 0x014 LCD FRM Seed Register (N=0,1,2,3,4,5) */
	__IO uint32_t FRM_TAB_REG [0x004];               /*!< Offset 0x02C LCD FRM Table Register (N=0,1,2,3) */
	__IO uint32_t LCD_3D_FIFO_REG;                       /*!< Offset 0x03C LCD 3D FIFO Register */
	__IO uint32_t CTL_REG;                           /*!< Offset 0x040 LCD Control Register */
	__IO uint32_t DCLK_REG;                          /*!< Offset 0x044 LCD Data Clock Register */
	__IO uint32_t BASIC0_REG;                        /*!< Offset 0x048 LCD Basic Timing Register0 */
	__IO uint32_t BASIC1_REG;                        /*!< Offset 0x04C LCD Basic Timing Register1 */
	__IO uint32_t BASIC2_REG;                        /*!< Offset 0x050 LCD Basic Timing Register2 */
	__IO uint32_t BASIC3_REG;                        /*!< Offset 0x054 LCD Basic Timing Register3 */
	__IO uint32_t HV_IF_REG;                         /*!< Offset 0x058 LCD HV Panel Interface Register */
	uint32_t reserved2;
	__IO uint32_t CPU_IF_REG;                        /*!< Offset 0x060 LCD CPU Panel Interface Register */
	__IO uint32_t CPU_WR_REG;                        /*!< Offset 0x064 LCD CPU Panel Write Data Register */
	__IO uint32_t CPU_RD0_REG;                       /*!< Offset 0x068 LCD CPU Panel Read Data Register0 */
	__IO uint32_t CPU_RD1_REG;                       /*!< Offset 0x06C LCD CPU Panel Read Data Register1 */
	uint32_t reserved3 [0x0005];
	__IO uint32_t LVDS_IF_REG;                       /*!< Offset 0x084 LCD LVDS Configure Register */
	__IO uint32_t IO_POL_REG;                        /*!< Offset 0x088 LCD IO Polarity Register */
	__IO uint32_t IO_TRI_REG;                        /*!< Offset 0x08C LCD IO Control Register */
	uint32_t reserved4 [0x001B];
	__IO uint32_t DEBUG_REG;                         /*!< Offset 0x0FC LCD Debug Register */
	__IO uint32_t CEU_CTL_REG;                       /*!< Offset 0x100 LCD CEU Control Register */
	uint32_t reserved5 [0x0003];
	__IO uint32_t CEU_COEF_MUL_REG [0x003];          /*!< Offset 0x110 LCD CEU Coefficient Register0 0x0110+N*0x04 (N=0..10) */
	__IO uint32_t CEU_COEF_ADD_REG [0x003];          /*!< Offset 0x11C LCD CEU Coefficient Register1 0x011C+N*0x10 (N=0,1,2) */
	uint32_t reserved6 [0x0006];
	__IO uint32_t CEU_COEF_RANG_REG [0x003];         /*!< Offset 0x140 LCD CEU Coefficient Register2 0x0140+N*0x04 (N=0,1,2) */
	uint32_t reserved7 [0x0005];
	__IO uint32_t CPU_TRI0_REG;                      /*!< Offset 0x160 LCD CPU Panel Trigger Register0 */
	__IO uint32_t CPU_TRI1_REG;                      /*!< Offset 0x164 LCD CPU Panel Trigger Register1 */
	__IO uint32_t CPU_TRI2_REG;                      /*!< Offset 0x168 LCD CPU Panel Trigger Register2 */
	__IO uint32_t CPU_TRI3_REG;                      /*!< Offset 0x16C LCD CPU Panel Trigger Register3 */
	__IO uint32_t CPU_TRI4_REG;                      /*!< Offset 0x170 LCD CPU Panel Trigger Register4 */
	__IO uint32_t CPU_TRI5_REG;                      /*!< Offset 0x174 LCD CPU Panel Trigger Register5 */
	uint32_t reserved8 [0x0002];
	__IO uint32_t CMAP_CTL_REG;                      /*!< Offset 0x180 LCD Color Map Control Register */
	uint32_t reserved9 [0x0003];
	__IO uint32_t CMAP_ODD0_REG;                     /*!< Offset 0x190 LCD Color Map Odd Line Register0 */
	__IO uint32_t CMAP_ODD1_REG;                     /*!< Offset 0x194 LCD Color Map Odd Line Register1 */
	__IO uint32_t CMAP_EVEN0_REG;                    /*!< Offset 0x198 LCD Color Map Even Line Register0 */
	__IO uint32_t CMAP_EVEN1_REG;                    /*!< Offset 0x19C LCD Color Map Even Line Register1 */
